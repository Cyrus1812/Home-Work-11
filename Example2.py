...
square_of_houses = [random.randint(100, 300) for i in range(len(number_of_houses))]
prices_of_houses = [random.randint(3000000, 20000000) for i in range(len(number_of_houses))]
...
plt.title("Стоимость домов за квадратный метр")   
...
with open('Houses.txt', 'w') as data:
